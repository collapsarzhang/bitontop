            ...
            async generateTransaction() {
                ...
                if (this.transferringToken.symbol === 'ETH') {
                    this.rawTransaction = {
                        ...
                        gasPrice: web3.utils.toHex(web3.utils.toWei(web3.utils.BN(this.gasPrice).toString(), 'Gwei')),
                        gasLimit: web3.utils.toHex(this.gasLimit),
                        to: this.toAddress,
                        value: web3.utils.toHex(web3.utils.toWei(web3.utils.BN(this.amount).toString())),
                        data: this.data,
                    ...
                    this.signedTransaction = {
                        ...
                        nonce: web3.utils.toHex(count),
                        gasPrice: web3.utils.toHex(web3.utils.toWei(web3.utils.toBN(this.gasPrice).toString(), 'Gwei')),
                        gasLimit: web3.utils.toHex(this.gasLimit),
                        to: this.toAddress,
                        value: web3.utils.toHex(web3.utils.toWei(web3.utils.toBN(this.amount).toString())),
                        data: this.data,
                        chainId: web3.utils.toHex(3)
                    }
                } else {
